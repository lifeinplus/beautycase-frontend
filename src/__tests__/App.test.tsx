...
describe('App', () => {
    describe('Component', () => {
        ...
        it('renders without crashing', () => {
            ...
            expect(
                screen.getByTestId('mocked-scroll-to-top')
            ).toBeInTheDocument()
            expect(
                screen.getByTestId('mocked-persist-login')
            ).toBeInTheDocument()
        })
    ...
    describe('Routing', () => {
        ...
        describe('Questionnaires', () => {
            ...
            it('renders the list page correctly', () => {
                ...
                const page = screen.getByTestId(
                    'mocked-questionnaire-list-page'
                )
                expect(page).toBeInTheDocument()
            })
            ...
            it('renders the result page correctly', () => {
                ...
                const page = screen.getByTestId(
                    'mocked-questionnaire-result-page'
                )
                expect(page).toBeInTheDocument()
            })
        })
