...
const AdaptiveNavBar = () => (
    <aside className="fixed bottom-0 left-0 z-20 flex w-full border-t border-gray-300 bg-white text-black sm:h-full sm:w-auto sm:flex-col sm:border-e sm:border-t-0 sm:px-3 sm:pb-5 sm:pt-2 lg:w-navbar-left-open dark:border-gray-700 dark:bg-black dark:text-white dark:sm:border-gray-800">
        ...
        <div className="flex w-full grow flex-row justify-evenly sm:flex-col sm:justify-start">
            <button
                className="my-1 flex p-2 hover:text-rose-400 sm:p-3 lg:gap-4"
