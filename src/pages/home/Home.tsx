                    ...
                    {username ? (
                        <>
                            ...
                            <button
                                className={classNames(
                                    'flex w-full justify-center gap-4 rounded-lg bg-rose-500 px-4 py-2 text-base font-semibold text-white transition-all hover:bg-rose-600 md:w-67 dark:bg-rose-600 dark:hover:bg-rose-700',
                        ...
                        <div className="mb-6 text-center">
                            ...
                            <div className="flex flex-col gap-3">
                                <Link
                                    className={classNames(
                                        'rounded-lg bg-rose-500 px-4 py-2 text-center font-semibold text-white transition-all hover:bg-rose-600 dark:bg-rose-600 dark:hover:bg-rose-700',
                                        'focus-visible:rounded focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-rose-600 focus-visible:outline-dashed dark:focus-visible:outline-rose-700'
                                    )}
                                    to={ROUTES.login}
                                >
                                ...
                                <Link
                                    className={classNames(
                                        'rounded-lg border border-rose-500 bg-white px-4 py-2 text-center font-semibold text-rose-500 transition-all hover:bg-neutral-100 dark:border-rose-600 dark:bg-black dark:hover:bg-neutral-800',
                                        'focus-visible:rounded focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-rose-600 focus-visible:outline-dashed dark:focus-visible:outline-rose-700'
                                    )}
                                    to={ROUTES.register}
                                >
