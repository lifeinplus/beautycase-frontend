...
import { useMakeupBagActions } from './useMakeupBagActions'
...
describe('useMakeupBagActions', () => {
    ...
    it('returns correct number of actions', () => {
        const { result } = renderHook(() => useMakeupBagActions())
    ...
    it('disables export when exporting', () => {
        const { result, rerender } = renderHook(() => useMakeupBagActions())
