            ...
            <div className="inline-flex items-center">
                ...
                >
                    <input
                        id={id}
                        type="checkbox"
                        className="peer size-6 cursor-pointer appearance-none rounded-sm border border-black shadow-sm transition-all checked:border-neutral-800 checked:bg-neutral-800 hover:shadow-md dark:border-white dark:checked:border-neutral-200 dark:checked:bg-neutral-200"
                        {...register}
                    />
